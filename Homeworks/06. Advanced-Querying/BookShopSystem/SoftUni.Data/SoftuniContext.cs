namespace SoftUni.Data
{
    ...
    public partial class SoftuniContext : DbContext
    {
        ...
        public IEnumerable<ProjectInfo> GetProjectsByEmployee(string firstName, string lastName)
        {
            ...
            return this.Database.SqlQuery<ProjectInfo>("FindAllProjectForEmployee @firstName, @lastName", firstNameParam, lastNameParam);
        }
